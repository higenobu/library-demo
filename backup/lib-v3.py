...
# -----------------------------------------------------------------------------
# Flask login routes (form-based login to ensure cookies are set)
# -----------------------------------------------------------------------------
LOGIN_PAGE_HTML = """
<!doctype html>
<html>
...
# -----------------------------------------------------------------------------
# Dash callbacks: signup (small), load rents table, handle clicks on table
# -----------------------------------------------------------------------------
@app.callback(
...
# populate table when page loads, refresh store changes, or manual refresh
@app.callback(
...
# detect clicks in DataTable via active_cell
@app.callback(
